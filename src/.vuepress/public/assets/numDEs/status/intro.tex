...
\vspace{-1em}
\begin{itemize}
\item 出勤记录: \href{https://wanghuaijin.github.io/assets/numDEs/status/attendance.xls}{出勤记录.xls}
\vspace{-1em}
\item 作业提交记录: \href{https://wanghuaijin.github.io/assets/numDEs/status/homework.xlsx}{作业记录.xls}
\end{itemize}
