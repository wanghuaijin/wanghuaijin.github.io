<template>
  ...
  export default {
    ...
    setup() {      
      const animationTime = 20; // seconds
      const days = 7;
  
      // Function to initialize timer animation
      const initTimerAnimation = () => {
        ...
        const deadlineAnimation = () => {
          setTimeout(() => {
            document.querySelector('#designer-arm-grop').style.animationDuration = '1.5s';
          }, 0);
  
          setTimeout(() => {
            document.querySelector('#designer-arm-grop').style.animationDuration = '1s';
          }, 4000);
  
          setTimeout(() => {
            document.querySelector('#designer-arm-grop').style.animationDuration = '0.7s';
          }, 8000);
  
          setTimeout(() => {
            document.querySelector('#designer-arm-grop').style.animationDuration = '0.3s';
          }, 12000);
  
          setTimeout(() => {
            document.querySelector('#designer-arm-grop').style.animationDuration = '0.2s';
          }, 15000);
        };
        ...
        //   const html = `<div class="mask-red"><div class="inner">${el.innerHTML}</div></div>
